...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 595 842">
  ...
  <text x="105" y="498" fill="#001f3d" font-family="SimSun, serif" font-size="12">操作简便 — 20 分钟内完成全部检查，一线操作员可快速上手</text>
  ...
  <text x="105" y="543" fill="#001f3d" font-family="SimSun, serif" font-size="12">场景适配 — 针对城市物流定制检查项（货物固定、隐私保护、噪音控制）</text>
  ...
  <text x="105" y="588" fill="#001f3d" font-family="SimSun, serif" font-size="12">分级管理 — A/B/C 三级适航评级，实现差异化风险管理</text>
